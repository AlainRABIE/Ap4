...
const abdoExercises: Array<{
...
}> = [
  {
    ...
    sets: 4,
    reps: "8-10",
    notes: "Exercice pour renforcer les abdominaux supérieurs avec une poulie",
  ...
  },
  {
    ...
    sets: 4,
    reps: "Max temps",
    notes: "Maintenez la position de planche aussi longtemps que possible",
  ...
  },
  {
    ...
    sets: 4,
    reps: "Max reps",
    notes: "Exercice pour travailler les abdominaux inférieurs",
    icon: "body-outline",
  },
];

export default function AbdoExoPage() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.title}>Programme Abdominaux</Text>
